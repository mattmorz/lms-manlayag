		...
		<div class="p-5 pb-10 space-y-6">
			...
			<div v-if="loading" class="space-y-6 animate-pulse">
				...
				<div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
					<div v-for="i in 3" :key="i" class="bg-surface-gray-2 border rounded-md h-24"></div>
				</div>
				...
				<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
					...
					<div class="lg:col-span-2 space-y-6">
						<div class="bg-surface-gray-2 border rounded-md h-28"></div>
						<div class="bg-surface-gray-2 border rounded-md h-80"></div>
						<div class="bg-surface-gray-2 border rounded-md h-48"></div>
					</div>

					<!-- Right Sidebar Skeleton -->
					<div class="space-y-6">
						<div class="bg-surface-gray-2 border rounded-md h-72"></div>
						<div class="bg-surface-gray-2 border rounded-md h-64"></div>
					</div>
				</div>
			</div>
